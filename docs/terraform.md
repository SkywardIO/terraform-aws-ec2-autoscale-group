...
| block\_device\_mappings | Specify volumes to attach to the instance besides the volumes specified by the AMI | <pre>list(object({<br>    device_name  = string<br>    no_device    = bool<br>    virtual_name = string<br>    ebs = object({<br>      delete_on_termination = bool<br>      encrypted             = bool<br>      iops                  = number<br>      kms_key_id            = string<br>      snapshot_id           = string<br>      volume_size           = number<br>      volume_type           = string<br>    })<br>  }))</pre> | <pre>[<br>  {<br>    "device_name": null,<br>    "ebs": {<br>      "delete_on_termination": true,<br>      "encrypted": true,<br>      "iops": null,<br>      "kms_key_id": null,<br>      "snapshot_id": null,<br>      "volume_size": null,<br>      "volumes_type": null<br>    },<br>    "no_device": false,<br>    "virtual_name": null<br>  }<br>]</pre> | no |
